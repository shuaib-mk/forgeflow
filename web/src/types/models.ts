...
export type WorkflowStep = { id: string; name: string; command: string; args?: string[]; dependsOn?: string[]; retries?: number; continueOnFail?: boolean }
export type Workflow = { id: string; projectId: string; name: string; version: number; steps: WorkflowStep[]; createdAt: string; updatedAt: string }
